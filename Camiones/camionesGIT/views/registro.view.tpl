...
<form action="index.php?page=registro" method="post">
    <label>Nombre de Usuario</label><input type="text" name="txtUserName" value="{{txtUserName}}"/>
    <br>
    <label>Nombre Completo</label><input type="text" name="txtName" value="{{txtName}}"/>
    <br>
